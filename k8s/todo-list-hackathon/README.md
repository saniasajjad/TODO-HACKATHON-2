...
This chart bootstraps a [Todo List Hackathon](https://github.com/saniasajjad/TODO-HACKATHON-2) deployment on a [Kubernetes](http://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
