    ...
    <>
      ...
      {!loading && !error && (
        <div className="text-sm text-muted-foreground mb-4 flex items-center gap-2">
          <span className="inline-flex items-center justify-center w-6 h-6 rounded-lg bg-primary/10 text-primary text-xs font-bold">
        ...
        <>
          {filteredTasks.length === 0 && (filters.searchQuery || filters.dueDate || (filters.tags && filters.tags.length > 0)) ? (
            <div className="text-center py-16 animate-fadeIn">
              ...
              <h3 className="text-sm font-semibold text-foreground">No tasks match your search</h3>
